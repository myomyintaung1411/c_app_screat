  ...
  <div class="relative min-h-screen min-w-full w-full    h-screen  items-center max-w-md sm:mx-auto   login__   ">
   ...
   <section class="   z-20  w-full  rounded-xl px-8 pt-16 max-w-md mx-auto">
    ...
    <form @click.prevent class="   relative text-[#999999]  w-full ">
              ...
              >
               <div class="flex items-center space-x-2">
                ...
                <input
                  ...
                  autocomplete="off"
                  placeholder=" 请输入用户名"
                  class="input-name  bg-transparent px-3 border-none outline-none text-[#333] focus:outline-none focus:border-none w-full h-full placeholder:text-[#999999] placeholder:font-medium placeholder:tracking-wide"
                   type="text" min="6" max="11" maxlength="20"
                />
              </div>
      </div>
      ...
      <div class=" px-4 rounded-md h-12 w-full  relative  bg-white bg-opacity-80 border border-[#999999] ">
        ...
        <div class="flex items-center space-x-2">
              ...
              v-model.trim="password"
                  autocomplete="off"
                  placeholder="请输入密码"
                  class="input-name  bg-transparent px-3 border-none text-[#333] outline-none focus:outline-none focus:border-none w-full h-full placeholder:text-[#999999] placeholder:font-medium placeholder:tracking-wide"
                  min="6"
                  max="17"
                  maxlength="17"
                  :type="passwordField"
      ...
      <div  class="flex justify-between items-center pt-4 text-[#fff] font-bold tracking-wider text-sm cursor-pointer"  >
